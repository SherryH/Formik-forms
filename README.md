...
This project is used for learning Formik.
Some extra examples can be found in this [codesandbox](https://codesandbox.io/s/l98zymm147)
Examples of creating custom fields can be found in the [Formik examples](https://github.com/jaredpalmer/formik/blob/master/examples/CustomInputs.js)
